...
public class StatsLeaderRow extends PlayerRow {
    ...
    public StatsLeaderRow(int rank, int playerId, String name, String chineseName, String countryId, Boolean active, double value, StatsCategory.Type categoryType) {
