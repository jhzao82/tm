...
public class MatchPlayerEx extends MatchPlayer {
    ...
    public MatchPlayerEx(int id, String name, String chineseName, Integer seed, String entry, String countryId, Integer rank, Integer eloRating, Integer nextEloRating) {
        super(id, name, chineseName, seed, entry, countryId);
		this.rank = rank;
