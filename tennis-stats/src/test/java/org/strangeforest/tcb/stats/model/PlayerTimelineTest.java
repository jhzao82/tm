...
class PlayerTimelineTest {
	...
	void simplePlayerTimelineIsCreated() {
        ...
        timeline.addItem(new PlayerTimelineItem(1, 1, "Australian Open", "Australian Open", 2001, 101, LocalDate.of(2001, 1, 15), "G", "H", false, "Australian Open", "SF"));
        timeline.addItem(new PlayerTimelineItem(1, 1, "Australian Open", "Australian Open", 2002, 201, LocalDate.of(2002, 1, 20), "G", "H", false, "Australian Open", "QF"));
        timeline.addItem(new PlayerTimelineItem(1, 1, "Australian Open", "Australian Open", 2003, 301, LocalDate.of(2003, 1, 18), "G", "H", false, "Australian Open", "W"));

        timeline.addItem(new PlayerTimelineItem(3, 3, "Miami", "Miami", 2002, 203, LocalDate.of(2002, 3, 5), "M", "H", false, "Miami", "QF"));
        timeline.addItem(new PlayerTimelineItem(3, 3, "Miami", "Miami", 2003, 303, LocalDate.of(2003, 3, 8), "M", "H", false, "Miami", "F"));

        timeline.addItem(new PlayerTimelineItem(4, 4, "Hamburg Masters", "Hamburg Masters", 2001, 104, LocalDate.of(2001, 4, 20), "M", "C", false, "Hamburg Masters", "R16"));
        timeline.addItem(new PlayerTimelineItem(4, 4, "Hamburg Masters", "Hamburg Masters", 2008, 804, LocalDate.of(2008, 4, 25), "A", "C", false, "Hamburg", "QF"));

        timeline.addItem(new PlayerTimelineItem(2, 2, "Roland Garros", "Roland Garros", 2002, 202, LocalDate.of(2002, 5, 10), "G", "C", false, "Roland Garros", "R16"));
        timeline.addItem(new PlayerTimelineItem(2, 2, "Roland Garros", "Roland Garros", 2003, 302, LocalDate.of(2003, 5, 18), "G", "C", false, "Roland Garros", "R32"));
        timeline.addItem(new PlayerTimelineItem(2, 2, "Roland Garros", "Roland Garros", 2004, 402, LocalDate.of(2004, 5, 15), "G", "C", false, "Roland Garros", "R64"));

        timeline.addItem(new PlayerTimelineItem(5, 5, "Stuttgart", "Stuttgart", 2001, 104, LocalDate.of(2001, 7, 20), "M", "C", false, "Stuttgart Masters", "R32"));
        timeline.addItem(new PlayerTimelineItem(5, 5, "Stuttgart", "Stuttgart", 2009, 904, LocalDate.of(2009, 7, 25), "A", "G", false, "Stuttgart", "SF"));
